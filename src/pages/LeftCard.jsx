...
const QuestionComp = ({ question }) => {
  return (<p className='bg-[#333] hover:bg-[#555] px-6 py-2 rounded-full text-xs hover:scale-105 transition duration-300'>
    {question}
  </p>)
}

const ReverseMarquee2 = () => {
  ...
  return (
    <div className="overflow-hidden w-full">
      ...
      >
        <QuestionComp question="Coffee or tea while coding?" />
        <QuestionComp question="What are your career goals?" />
        <QuestionComp question="What is your strongest technical skill?" />
        <QuestionComp question="How can I contact you?" />
  ...
  return (
    <section
      ...
      <div className='sm:mt-[15vh] h-screen sm:h-[80vh] bg-[#fff]/70 dark:bg-[#111] shadow dark:shadow-white/20 transition w-full duration-300 relative rounded-xl flex flex-col'>
              ...
              {Object.entries(chatHistory).map(([key, value], index) => {
                return <div key={index} className='flex flex-col w-full'>
                  ...
                  {value == null ? <div className="relative flex flex-col -translate-x-[35px] w-64 animate-pulse gap-2 p-4 scale-80">
                    ...
                    <svg viewBox="0 0 61 49" xmlSpace="preserve" className='fill-white size-8 rounded-xl z-[50]'>
                    ...
                    <div initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className=' self-start bg-white px-3 py-1 rounded-lg relative'>
                      <p className='text-xs z-[10] relative'>
                        {value}
                      </p>
        ...
        {/* bottom */}
        <div className="w-full px-5 py-5 rounded-3xl overflow-hidden flex items-center gap-2 border-t-2 border-black/20 dark:border-white/10">
          {/* input container with mic and clear text button */}
          <div className='w-full relative flex items-center pr-2 h-[40px]'>
            {!recieveMsg && <>
          ...
          <div
            ...
            {(msgText.length == 0 && !recieveMsg) && <svg viewBox="0 0 24 24" fill="none" className='stroke-white size-6'>
              <rect x="9" y="3" width="6" height="11" rx="3" strokeLinejoin="round"></rect>
              <path d="M5.5 11C5.5 12.7239 6.18482 14.3772 7.40381 15.5962C8.62279 16.8152 10.2761 17.5 12 17.5C13.7239 17.5 15.3772 16.8152 16.5962 15.5962C17.8152 14.3772 18.5 12.7239 18.5 11" strokeLinecap="round" strokeLinejoin="round"></path>
              <path d="M12 21V19" strokeLinecap="round" strokeLinejoin="round"></path>
            </svg>}
